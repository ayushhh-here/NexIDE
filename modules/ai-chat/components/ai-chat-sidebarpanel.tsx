...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
    ...
    // Load any previously saved chat history the first time the panel opens.
    useEffect(() => {
        if (!isOpen) return;
        ...
        (async () => {
            ...
            setMessages((prev) => {
                // Don't clobber messages the user has already sent in this session.
   ...
   const handleSendMessage = async (e: React.FormEvent) => {
    ...
    // Fire-and-forget persistence - don't block the UI on the DB write.

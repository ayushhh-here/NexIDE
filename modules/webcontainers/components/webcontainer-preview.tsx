...
// Templates differ in what their package.json calls the dev-server script -
// Next.js/Angular use "start", everything else (React/Vue/Express/Hono) only
// defines "dev". Hardcoding one or the other means half the templates fail
// with "missing script" the moment the container tries to run them.
function resolveDevCommand(templateData: TemplateFolder): string[] {
  ...
  // Reasonable default: "dev" is what most of our starter templates use.
  return ["run", "dev"];
}
  ...
  useEffect(() => {
    async function setupContainer() {
      ...
      try {
        ...
        const startProcess = await instance.spawn("npm", resolveDevCommand(templateData));

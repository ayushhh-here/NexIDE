...
import type { editor as MonacoEditorNS, Position, CancellationToken, languages, IDisposable } from "monaco-editor"
import { TemplateFile } from "../lib/path-to-json"
import { configureMonaco, defaultEditorOptions, getEditorLanguage } from "../lib/editor-config"

type IStandaloneCodeEditor = MonacoEditorNS.IStandaloneCodeEditor
...
interface PlaygroundEditorProps {
  ...
  onAcceptSuggestion: (editor: IStandaloneCodeEditor | null, monaco: Monaco | null) => void
  onRejectSuggestion: (editor: IStandaloneCodeEditor | null) => void
  onTriggerSuggestion: (type: string, editor: IStandaloneCodeEditor | null) => void
}
...
export const PlaygroundEditor = ({
  ...
  const handleEditorDidMount = (editor: IStandaloneCodeEditor, monaco: Monaco) => {
    ...
    editor.onDidChangeCursorPosition((e: MonacoEditorNS.ICursorPositionChangedEvent) => {
    ...
    editor.onDidChangeModelContent((e: MonacoEditorNS.IModelContentChangedEvent) => {
      if (isAcceptingSuggestionRef.current) return
